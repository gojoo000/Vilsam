		...
		<div class="wrap-inner">
			...
			<div class="section" id="section2">
				<div class="form form--signup">
							...
							<table>
								...
								<tr>
									...
									<td>
										...
										<c:if test="${member.MEMBER_GENDER eq'2'}">여자</c:if>
									</td>
								</tr>
								<tr>
					...
					<c:choose>
						<c:when test="${MEMBER_TYPE eq 'admin' }">
							<a href="/Vilsam_yj/memberDeleteAction.me?MEMBER_ID=${member.MEMBER_ID}" class="btst">추방하기</a>
						</c:when>
						<c:otherwise>
							<a href="/Vilsam_yj/memberDeleteAction.me?MEMBER_ID=${member.MEMBER_ID}" class="btst">탈퇴하기</a>
						</c:otherwise>
					</c:choose>
						<a href="#none" id="btnModify" class="btst">수정하기</a>
						<a href="/Vilsam_yj/memberListAction.me" id="btnBack" class="btst">돌아가기</a>
				</div>
			</div>
		</div>
