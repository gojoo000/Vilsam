			...
			<div class="section" id="section2">
				<div class="form form--signup">
					<form name="loginform" id="Delform"
						...
						<br> <br> <a href="/Vilsam_yj/sellList.se?MEMBER_ID=${member.MEMBER_ID}" class="btst">내 주문내역 보기</a> <br>
					<%-- 	<h1 class="alpha">공간 예약내역</h1>
						<br> <br> <a href="/Vilsam_yj/reservationList.reser?MEMBER_ID=${MEMBER_ID}" class="btst">내 예약내역 보기</a> <br> --%>
					</form>
